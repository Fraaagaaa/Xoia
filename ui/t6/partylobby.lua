...
LUI.createMenu.ResetStatsPopup = function (f9_arg0)
	...
	CoD.perController[f9_arg0].firstTime = true
	CoD.PopupMenus.SetupConfirmPopup(ResetStatsPopup, Engine.Localize("MPUI_RESET_STATS"), Engine.Localize("MENU_RESET_STATS_DESC"), CoD.PopupMenus.ResetStats, CoD.PopupMenus.ClosePopupAfterConfirmation)
...
CoD.PartyLobby.UpdateButtonPaneButtonVisibility = function (f15_arg0)
	...
	-- 	f15_arg0.body.buttonList:addElement(f15_arg0.body.findMatchButton)
		f15_arg0.body.buttonList:addElement(f15_arg0.body.serverBrowserButton)
	else
		...
		-- 	})
		-- end
		f15_arg0.body.serverBrowserButton:closeAndRefocus(f15_arg0.body.createAClassButton)
	end
...
CoD.PartyLobby.PopulateButtons_Multiplayer = function (PartyLobbyButtonPane)
	PartyLobbyButtonPane.body.serverBrowserButton = PartyLobbyButtonPane.body.buttonList:addButton(Engine.Localize("MENU_SERVER_BROWSER_CAPS"), nil, 1)
	PartyLobbyButtonPane.body.serverBrowserButton.hintText = Engine.Localize("MENU_SERVER_BROWSER_DESC")
	PartyLobbyButtonPane.body.serverBrowserButton:setActionEventName("open_server_browser_mainlobby")
	--CoD.SetupMatchmakingLock(PartyLobbyButtonPane.body.serverBrowserButton)
	PartyLobbyButtonPane.body.createAClassButton = PartyLobbyButtonPane.body.buttonList:addButton(Engine.Localize("MENU_CREATE_A_CLASS_CAPS"), nil, 2)
	...
	PartyLobbyButtonPane.body.rewardsButton = PartyLobbyButtonPane.body.buttonList:addButton(Engine.Localize("MENU_SCORE_STREAKS_CAPS"), nil, 3)
...
CoD.PartyLobby.new = function (f29_arg0, f29_arg1, f29_arg2)
	...
	PartyLobbyWidget:registerEventHandler("open_server_browser_mainlobby", CoD.MainLobby.OpenIMGUIServerBrowser)
	...
	if CoD.useController then
		...
		elseif CoD.isPartyHost() then
			PartyLobbyWidget.buttonPane.body.serverBrowserButton:processEvent({
				name = "gain_focus"
			})
		else
