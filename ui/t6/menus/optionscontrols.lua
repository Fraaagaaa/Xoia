...
LUI.createMenu.OptionsControlsMenu = function (localClientIndex)
	...
	-- (optionsxoia.lua) y OptionsSettingsMenu (optionssettings.lua). Este
	-- archivo no guarda en una variable el resultado de
	-- UIExpression.IsInGame() (se usa directo en el if de la linea 537),
	-- asi que se vuelve a comprobar aqui en vez de reestructurar codigo
