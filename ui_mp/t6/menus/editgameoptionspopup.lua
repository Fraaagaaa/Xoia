...
LUI.createMenu.EditGameOptions = function (LocalClientIndex)
	...
	EditGameOptionsPopup.resetToDefaultButton = CoD.ButtonPrompt.new("select", Engine.Localize("MENU_RESET_TO_DEFAULT"), EditGameOptionsPopup, "button_prompt_reset_to_default", false, nil, nil, nil, "R")
	EditGameOptionsPopup:addRightButtonPrompt(EditGameOptionsPopup.resetToDefaultButton)
	EditGameOptionsPopup.saveButton = CoD.ButtonPrompt.new("alt1", Engine.Localize("MENU_SAVE"), EditGameOptionsPopup, "button_prompt_save_game_settings", false, nil, nil, nil, "S")
