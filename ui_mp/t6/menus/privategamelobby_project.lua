...
CoD.PrivateGameLobby.Dvars[1].name = "MENU_MINPLAYERS_CAPS"
CoD.PrivateGameLobby.Dvars[1].hintText = "MENU_MINPLAYERS_HINT"
...
CoD.PrivateGameLobby.Dvars[2].hintText = "MENU_TARGET_ASSIST_HINT"
...
CoD.PrivateGameLobby.Dvars[3].id = "sv_cheats"
CoD.PrivateGameLobby.DvarDefaults["sv_cheats"] = 0
CoD.PrivateGameLobby.Dvars[3].name = "MENU_CHEATS_CAPS"
CoD.PrivateGameLobby.Dvars[3].hintText = "MENU_CHEATS_HINT"
CoD.PrivateGameLobby.Dvars[3].labels = {}
CoD.PrivateGameLobby.Dvars[3].labels[1] = "MENU_DISABLED_CAPS"
CoD.PrivateGameLobby.Dvars[3].labels[2] = "MENU_ENABLED_CAPS"
